...
export const deleteRemoteContentError = createAction("DELETE_REMOTE_CONTENT_ERROR");
export const deleteRemoteContentPending = createAction("DELETE_REMOTE_CONTENT_PENDING");
export const deleteRemoteContentSuccess = createAction("DELETE_REMOTE_CONTENT_SUCCESS");
