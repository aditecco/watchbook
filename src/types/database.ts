...
export type ContentTagInsert =
  Database["public"]["Tables"]["content_tags"]["Insert"];
...
export type ContentWithTags =
  Database["public"]["Views"]["content_with_tags"]["Row"];
export type ContentWithNotes =
  Database["public"]["Views"]["content_with_notes"]["Row"];
